...
data_path=/mntcephfs/lab_data/zxy/2023_ntu-recordings_16kv2/ # need change
...
spk_path=${data_path}/target_embedding/

results_path=the_path_of_your_results # need change


python3 ${ts_vad_path}/generate_ntu.py ${data_path} \
